...
async function IndexController() {
  const el_sidebar_all_project_wrapper = document.getElementById(
    "sidebar_all_project_wrapper"
  );
  ...
  const el_modal_create_new_project_wrapper = document.getElementById(
    "index_modal_create_new_project_wrapper"
  );
  ...
  CreateProject.render(
    el_modal_create_new_project_wrapper,
    el_index_modal_create_new_project
  );
